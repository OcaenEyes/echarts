...
var init_demo03 = () => {
    ...
    var chartDom = document.getElementById('demo03') as HTMLElement;
    var myChart = echarts.init(chartDom);
...
var init_demo04 = () => {
    var chartDom = document.getElementById('demo04') as HTMLElement;
    var myChart = echarts.init(chartDom);
    type EChartsOption = echarts.EChartsOption;
    var option: EChartsOption;
    interface DataMap {
        ...
        options: [
            {
                ...
                series: [
                    ...
                    {
                        data: [
                            { name: '新书', value: dataMap.dataPI['2002sum'] },
                            { name: '连载', value: dataMap.dataSI['2002sum'] },
                            { name: '完结', value: dataMap.dataTI['2002sum'] }
                        ]
                    }
                ]
            },
            {
                ...
                series: [
                    ...
                    {
                        data: [
                            { name: '新书', value: dataMap.dataPI['2003sum'] },
                            { name: '连载', value: dataMap.dataSI['2003sum'] },
                            { name: '完结', value: dataMap.dataTI['2003sum'] }
                        ]
                    }
                ]
            },
            {
                ...
                series: [
                    ...
                    {
                        data: [
                            { name: '新书', value: dataMap.dataPI['2004sum'] },
                            { name: '连载', value: dataMap.dataSI['2004sum'] },
                            { name: '完结', value: dataMap.dataTI['2004sum'] }
                        ]
                    }
                ]
            },
            {
                ...
                series: [
                    ...
                    {
                        data: [
                            { name: '新书', value: dataMap.dataPI['2005sum'] },
                            { name: '连载', value: dataMap.dataSI['2005sum'] },
                            { name: '完结', value: dataMap.dataTI['2005sum'] }
                        ]
                    }
                ]
            },
            {
                ...
                series: [
                    ...
                    {
                        data: [
                            { name: '新书', value: dataMap.dataPI['2006sum'] },
                            { name: '连载', value: dataMap.dataSI['2006sum'] },
                            { name: '完结', value: dataMap.dataTI['2006sum'] }
                        ]
                    }
                ]
            },
            {
                ...
                series: [
                    ...
                    {
                        data: [
                            { name: '新书', value: dataMap.dataPI['2007sum'] },
                            { name: '连载', value: dataMap.dataSI['2007sum'] },
                            { name: '完结', value: dataMap.dataTI['2007sum'] }
                        ]
                    }
                ]
            },
            {
                ...
                series: [
                    ...
                    {
                        data: [
                            { name: '新书', value: dataMap.dataPI['2008sum'] },
                            { name: '连载', value: dataMap.dataSI['2008sum'] },
                            { name: '完结', value: dataMap.dataTI['2008sum'] }
                        ]
                    }
                ]
            },
            {
                ...
                series: [
                    ...
                    {
                        data: [
                            { name: '新书', value: dataMap.dataPI['2009sum'] },
                            { name: '连载', value: dataMap.dataSI['2009sum'] },
                            { name: '完结', value: dataMap.dataTI['2009sum'] }
                        ]
                    }
                ]
            },
            {
                ...
                series: [
                    ...
                    {
                        data: [
                            { name: '新书', value: dataMap.dataPI['2010sum'] },
                            { name: '连载', value: dataMap.dataSI['2010sum'] },
                            { name: '完结', value: dataMap.dataTI['2010sum'] }
                        ]
                    }
                ]
            },
            {
                ...
                series: [
                    ...
                    {
                        data: [
                            { name: '新书', value: dataMap.dataPI['2011sum'] },
                            { name: '连载', value: dataMap.dataSI['2011sum'] },
                            { name: '完结', value: dataMap.dataTI['2011sum'] }
                        ]
                    }
                ]
            }
...
<template>
    <div class="demo-page">
        ...
        <div class="demo">
            <div class="custom-test" id="demo01"></div>
        </div>

        <div class="demo">
            <div class="custom-test" id="demo03"></div>
        </div>
